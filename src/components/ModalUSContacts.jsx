...
export default function ModalUSContacts() {
    ...
    useEffect(() => {
      ...
      const fetchContacts = async (country) => {
        try {
          ...
          const response = await fetch(`https://contact.mediusware.com/api/country-contacts/${country}/`);
